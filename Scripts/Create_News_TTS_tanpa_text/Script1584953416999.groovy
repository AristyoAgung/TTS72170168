...
WebUI.setText(findTestObject('Object Repository/Page_CodeIgniter Tutorial/input_Title_title'), 'kepala hancur')
...
WebUI.verifyElementPresent(findTestObject('Page_CodeIgniter Tutorial/p_The Text field is required'), 5)
